...
#ifndef ELECTRON_SHELL_BROWSER_CRYPTO_MODULE_DELEGATE_NSS_H_
#define ELECTRON_SHELL_BROWSER_CRYPTO_MODULE_DELEGATE_NSS_H_
...
class ChromeNSSCryptoModuleDelegate
 ...
 public:
  ...
  ChromeNSSCryptoModuleDelegate(const net::HostPortPair& server);
...
CreateCryptoModuleBlockingPasswordDelegate(const net::HostPortPair& server);

#endif  // ELECTRON_SHELL_BROWSER_CRYPTO_MODULE_DELEGATE_NSS_H_
